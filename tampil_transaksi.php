        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            ...
            <div class="col-lg-6 col-5 text-right">
              <a href="tambah_transaksi.php" class="btn btn-sm btn-neutral">Add New Transaction</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header border-0">
              <center><h3 class="mb-0">Transaction</h3></center>
            </div>
            <!-- Transaction Data -->
            <div class="table-responsive">
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                        ...
                        <?php
                        include 'koneksi.php';
                        $mysqli = "select transaksi.*, member.nama, user.nama_user 
                        ...
                        <tr>            
                            ...
                            <td><a href="ubah_transaksi.php?id_transaksi=<?php echo $data_transaksi['id_transaksi']?>"> <button class="btn btn-primary px-2">Edit</button></a>

                            <td><a href="hapus_transaksi.php?id_transaksi=<?php echo $data_transaksi['id_transaksi']?>"> <button onclick="return confirm('Are you sure to delete this date?')" class="btn btn-primary px-2">Delete</button></a>
                        </tr>
                        <?php 
                        }
                        ?>
