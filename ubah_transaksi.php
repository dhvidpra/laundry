            ...
            <div class="col-lg-6 col-7">
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Edit Transaction Data</li>
                </ol>
              </nav>
            </div>
          </div>
        ...
        <div class="col-md-10 ml-auto mr-auto">
          <div class="card card-upgrade">
            <div class="card-header text-center border-bottom-0">
              <center><h4 class="card-title">Edit Transaction Data</h4></center>
            </div>
            <div class="card-body">
              <div class="table-responsive table-upgrade">
                <table class="table">
                  <tbody>
                  Name :
                  <input type="text" name="id_paket" value="<?=$data_paket['id_paket']?>" class="form-control">
                  Type :
                  ...
                  <input type="text" name="harga" value="<?=$data_paket['harga']?>" class="form-control">
                   <br>
                    <center><input type="submit" name="simpan" value="Edit Package Data" class="btn btn-primary"></center>
                  </tbody>
                </table>
              </div>
            </div>
