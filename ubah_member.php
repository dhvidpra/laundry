            ...
            <div class="col-lg-6 col-7">
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item"><a href="tampil_member.php">Customer</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Edit Customer Data</li>
                </ol>
              </nav>
            </div>
          </div>
        ...
        <div class="col-md-10 ml-auto mr-auto">
          <div class="card card-upgrade">
            <div class="card-header text-center border-bottom-0">
              <center><h4 class="card-title">Edit Customer Data</h4></center>
            </div>
            <div class="card-body">
              <div class="table-responsive table-upgrade">
                <table class="table">
                  ...
                  Gender :
                  <?php 
                  $arr_jenis_kelamin=array('L'=>'Male','P'=>'Female');
                  ?>
                  <select name="jenis_kelamin" class="form-control">
                   ...
                   <br>
                    <center><input type="submit" name="simpan" value="Edit Customer Data" class="btn btn-primary"></center>
                  </tbody>
                </table>
              </div>
            </div>
