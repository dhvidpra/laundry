            ...
            <div class="col-lg-6 col-7">
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  <li class="breadcrumb-item"><a href="home_admin.php"><i class="fas fa-home"></i></a></li>
                  <li class="breadcrumb-item"><a href="tampil_user.php">Users</a></li>
              ...
              <div class="table-responsive table-upgrade">
                <table class="table">
                  ...
                  <select name="role" class="form-control">
                    ...
                    <br>
                    <center><input type="submit" name="simpan" value="Sign Up" class="btn btn-primary"></center>
                  </tbody>
                </table>
              </div>
            </div>
