  ...
  <nav id="navbar-main" class="navbar navbar-horizontal navbar-transparent navbar-main navbar-expand-lg navbar-light">
    <div class="container">
      <a class="navbar-brand" href="home.php">
        <img src="assets/img/brand/puti.png">
      </a>
        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-6 col-md-8 px-5">
              ...
              <p class="text-lead text-white">Login to your beautify day.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-lg-5 col-md-7">
          <div class="card bg-secondary border-0 mb-0">
            <div class="card-header bg-transparent pb-5">
              <div class="text-muted text-center mt-2 mb-3"><small>Log in with</small></div>
            ...
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <form action="proses_login.php" method="post">
                ...
                <div class="text-center">
                  <center><input type="submit" name="login" class="btn btn-primary my-4" value="LOGIN"></center>
                </div>
              </form>
            </div>
          </div>
