        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            ...
            <div class="col-lg-6 col-5 text-right">
              <a href="tambah_member.php" class="btn btn-sm btn-neutral">Add New Customer</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col">
          <div class="card">
            ...
            <div class="card-header border-0">
              <center><h3 class="mb-0">Customer's Data</h3></center>
            </div>
            <!-- Customer's Data -->
                      ...
                      if($data_member['jenis_kelamin'] == 'L') {
                       $jk = "Laki-Laki";
                        ...
                        <tr>              
                          ...
                          <td><a href="ubah_member.php?id_member=<?=$data_member['id_member']?>" class="btn btn-primary">Edit</a> | <a href="hapus_member.php?id_member=<?=$data_member['id_member']?>" onclick="return confirm('Apakah anda yakin menghapus data ini?')" class="btn btn-primary">Delete</a></td>
                        </tr>
                        <?php 
                        }
                        ?>
